...
class MultiLayerPerceptron(object):
    ...
    def back_propagation(self, cache, X, y, L2_norm=0.0):
        ...
        dtanh = 1 - np.tanh(h3 + h1)**2  # tanh 미분 저장
        dh3 = dz3 * dtanh                # dz3 → h3로의 gradient 전달
        ...
        drelu = dz1 * (h1 > 0)             # ReLU 역전파
        dtanh_to_h1 = dh3 * dtanh          # tanh 경로의 h1 부분
        dh1 = drelu + dtanh_to_h1          # 두 gradient 합치기
